...
function schema({ colors, styles }) {
  return `{
    ...
    "colors": {
      ...
      "editor.findMatchBackground": "${colors.offWhite}20",
      "editor.findMatchHighlightBackground": "${colors.offWhite}20",
      ...
      "editor.findRangeHighlightBackground": "${colors.offWhite}20",
      ...
      "editor.wordHighlightBackground": "${colors.focus}",
      "editor.wordHighlightStrongBackground": "${colors.bluishGray}80",
