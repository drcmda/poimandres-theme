...
function schema({ colors, styles }) {
  return `{
    ...
    "colors": {
      ...
      "editor.selectionHighlightBorder": "${colors.lightBlue}",
      "editor.wordHighlightBackground": "${colors.lightBlue}40",
      "editor.wordHighlightStrongBackground": "${colors.lightBlue}80",
